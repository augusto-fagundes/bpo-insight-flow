...
const mockCompanies: Company[] = [
  {
    ...
    cost: 94375,
    sector: "Tecnologia",
    monthlyProfitabilityVariation: 2.3,
    cumulativeProfitabilityVariation: 8.1,
    averageTicket: 4167,
    totalRevenueContribution: 18.5,
    trend: 'up' as const,
    monthlyRevenue: [
  ...
  },
  {
    ...
    cost: 80164,
    sector: "Marketing",
    monthlyProfitabilityVariation: -1.2,
    cumulativeProfitabilityVariation: 3.5,
    averageTicket: 3267,
    totalRevenueContribution: 14.5,
    trend: 'down' as const,
    monthlyRevenue: [
  ...
  },
  {
    ...
    cost: 106548,
    sector: "Inovação",
    monthlyProfitabilityVariation: 4.2,
    cumulativeProfitabilityVariation: 12.3,
    averageTicket: 5200,
    totalRevenueContribution: 23.1,
    trend: 'up' as const,
    monthlyRevenue: [
  ...
  },
  {
    ...
    cost: 73254,
    sector: "Digital",
    monthlyProfitabilityVariation: 0.3,
    cumulativeProfitabilityVariation: 1.8,
    averageTicket: 2900,
    totalRevenueContribution: 12.9,
  ...
  },
  {
    ...
    cost: 104082,
    sector: "Saúde",
    monthlyProfitabilityVariation: 1.8,
    cumulativeProfitabilityVariation: 6.2,
    averageTicket: 4467,
    totalRevenueContribution: 19.8,
    trend: 'up' as const,
    monthlyRevenue: [
  ...
  },
  {
    ...
    cost: 69540,
    sector: "Varejo",
    monthlyProfitabilityVariation: -0.8,
    cumulativeProfitabilityVariation: -2.1,
    averageTicket: 2533,
    totalRevenueContribution: 11.2,
    trend: 'down' as const,
    monthlyRevenue: [
      { month: "Jan", value: 11500 },
      { month: "Fev", value: 12200 },
